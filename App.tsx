...
import PromptSettingsScreen from "./src/features/board/PromptSettingsScreen";
...
function App() {
  ...
  const [status, setStatus] = useState<"loading" | "no-profile" | "ok">(
    "loading",
  );
    ...
    <PaperProvider>
      <NavigationContainer>
        <Stack.Navigator>
          ...
          <Stack.Screen
            name="PromptSettings"
            component={PromptSettingsScreen}
            options={{ title: "プロンプト変更" }}
          />
        </Stack.Navigator>
      </NavigationContainer>
    </PaperProvider>
